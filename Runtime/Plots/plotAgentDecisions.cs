...
{
    public SocialMachineLearningAgent[] allAgents;
    ...
    void DrawGraph(int windowID)
    {
        ...
        if (Event.current.type == EventType.Repaint)
        {
            ...
            GL.Vertex3(0, windowRect.height / 2 + allAgents[0].thresholdDDM * scale, 0);
            GL.Vertex3(windowRect.width, windowRect.height / 2 + allAgents[0].thresholdDDM * scale, 0);
